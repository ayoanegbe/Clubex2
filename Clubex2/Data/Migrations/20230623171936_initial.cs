    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ContentSearches",
                columns: table => new
                {
                    ContentSerchId = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContentSearches", x => x.ContentSerchId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ExecutivePositionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExecutivePositions", x => x.ExecutivePositionId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Currencys_Countries_CountryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MeetingAgendaId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AgendaItem = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MeetingId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MeetingAgendas", x => x.MeetingAgendaId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Communication_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "OrganizationId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_Communication_CommunicationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExecutivePositionId = table.Column<int>(type: "int", nullable: false),
                    OganizationId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "ExecutivePositionId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Executives_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "OrganizationId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_CommunicationId",
                table: "Comments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Communication_OrganizationId",
                table: "Communication",
                column: "OrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_Currencys_CountryId",
                table: "Currencys",
                column: "CountryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Executives_OrganizationId",
                table: "Executives",
                column: "OrganizationId");
